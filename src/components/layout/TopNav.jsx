      ...
      <div className="mx-auto flex max-w-6xl items-center gap-2 overflow-x-auto px-4 py-3 sm:px-6">
        {items.map((item) => (
          <button
            ...
            className={page === item
              ? 'rounded-full bg-[#d4ff6a] px-4 py-2.5 text-sm font-semibold text-black'
              : 'rounded-full px-4 py-2.5 text-sm font-medium text-[#c7d0c2] transition hover:bg-white/5 hover:text-white'}
          >

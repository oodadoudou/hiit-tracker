...
export const SEEDED_DAILY_METRICS = {
  '2026-03-29': {
    intake: 980,
    intakeRangeText: '780-1180',
    totalBurn: 1900,
    totalBurnRangeText: '1900',
    deficit: -900,
    deficitRangeText: '-700 ~ -1100',
    status: '减脂',
    note: '稳定',
  },
  '2026-03-30': {
    intake: 1120,
    intakeRangeText: '960-1280',
    totalBurn: 2060,
    totalBurnRangeText: '2060',
    deficit: -940,
    deficitRangeText: '-780 ~ -1100',
    status: '减脂',
    note: '活动较多',
  },
  '2026-03-31': {
    intake: 1070,
    intakeRangeText: '910-1230',
    totalBurn: 1780,
    totalBurnRangeText: '1780',
    deficit: -710,
    deficitRangeText: '-550 ~ -870',
    status: '减脂',
    note: '正常',
  },
  '2026-04-01': {
    intake: 1505,
    intakeRangeText: '1260-1750',
    totalBurn: 1800,
    totalBurnRangeText: '1800',
    deficit: -270,
    deficitRangeText: '-540 ~ 0',
    status: '维持',
    note: '边界',
  },
  '2026-04-02': {
    intake: 2485,
    intakeRangeText: '2020-2950',
    totalBurn: 1920,
    totalBurnRangeText: '1920',
    deficit: 550,
    deficitRangeText: '+100 ~ +1000',
    status: '盈余',
    note: '外食',
  },
  '2026-04-03': {
    intake: 685,
    intakeRangeText: '570-800',
    totalBurn: 1960,
    totalBurnRangeText: '1960',
    deficit: -1250,
    deficitRangeText: '-1100 ~ -1400',
    status: '强减脂',
    note: '极低摄入',
  },
  '2026-04-04': {
    intake: 1330,
    intakeRangeText: '1160-1500',
    totalBurn: 1800,
    totalBurnRangeText: '1800',
    deficit: -475,
    deficitRangeText: '-250 ~ -700',
    status: '稳定减脂',
    note: '恢复',
  },
  '2026-04-05': {
    intake: 990,
    intakeRangeText: '880-1100',
    totalBurn: 2120,
    totalBurnRangeText: '2120',
    deficit: -1100,
    deficitRangeText: '-1000 ~ -1200',
    status: '强减脂',
    note: '过猛',
  },
  '2026-04-06': {
    intake: 1015,
    intakeRangeText: '940-1090',
    totalBurn: 1800,
    totalBurnRangeText: '1800',
    deficit: -800,
    deficitRangeText: '-700 ~ -900',
    status: '减脂',
    note: '稳定',
  },
  '2026-04-07': {
    ...
    intakeRangeText: '940-1090',
    totalBurn: 1675,
    totalBurnRangeText: '1650-1700',
    deficit: -675,
    deficitRangeText: '-600 ~ -750',
    status: '减脂',
    note: '低活动',
  },
  '2026-04-08': {
    intake: 2245,
    intakeRangeText: '2060-2430',
    totalBurn: 2000,
    totalBurnRangeText: '1900-2100',
    deficit: -245,
    deficitRangeText: '-530 ~ +40',
    status: '维持',
    note: '辣条日',
  },
  '2026-04-09': {
    intake: 1385,
    intakeRangeText: '1150-1620',
    totalBurn: 2175,
    totalBurnRangeText: '2050-2300',
    deficit: -665,
    deficitRangeText: '-900 ~ -430',
    status: '减脂',
    note: '运动日',
  },
  '2026-04-10': {
    intake: 1530,
    intakeRangeText: '1230-1830',
    totalBurn: 2175,
    totalBurnRangeText: '2050-2300',
    deficit: -410,
    deficitRangeText: '-820 ~ 0',
    status: '减脂/维持',
    note: '双训练',
  },
  '2026-04-11': {
    intake: 1030,
    intakeRangeText: '800-1260',
    totalBurn: 1800,
    totalBurnRangeText: '1700-1900',
    deficit: -650,
    deficitRangeText: '-900 ~ -400',
    status: '减脂',
    note: '偏低摄入',
  },
};
